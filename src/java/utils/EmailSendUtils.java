...
public class EmailSendUtils {
    ...
    public static boolean send(String email, String loginUserID, String invitedID) {
        try {
            ...
            message.setText("ID: " + loginUserID + "\n"
                    + " have requested " + invitedID + " to their Capstone Group" + "\n"
